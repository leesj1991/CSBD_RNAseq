# RNAseq_figure_CHD8_20220830v1.R
...
reverse_plot = 1
for (useSample in 1:3) {
  
  group_list = c("Str P56 Female KO", 
                 "Str P56 Male KO", 
                 "Str P56 Female HT", 
                 "Str P56 Male HT", 
                 "Ctx P56 Female KO", 
  ...
  if(useSample == 0){
    ...
    geneset_for_direction_reverse = c("DEG DOWN VOINEAGU__ASD_RISK", 
                                      "COEX DOWN M12 VOINEAGU__ASD_RISK", 
                                      "SFARIGENE__ASD_RISK", 
                                      "SFARIGENE(HIGH CONFIDENCE)__ASD_RISK", 
                                      "FMRPTARGETS__ASD_RISK", 
    ...
    geneset_for_direction_reverse = c("OLIGODENDROCYTES PROGE__SUB_CELLTYPE", 
                                      "OPC__SINGLECELL_VELMESHEV", 
                                      "OLIGODENDROCYTES CAHOY__CELL_TYPE", 
                                      "OLIGODENDROCYTES ZEISEL__CELL_TYPE", 
                                      "OLIGODENDROCYTES MATURE__SUB_CELLTYPE", 
    ...
    geneset_for_direction_reverse = c("NEURONS CAHOY__CELL_TYPE", 
                                      "S1 PYRNEURONS ZEISEL__CELL_TYPE", 
                                      "CA1 PYRNEURONS ZEISEL__CELL_TYPE", 
                                      "CTX GLU LAYER1__SUB_CELLTYPE", 
                                      "L2-3__SINGLECELL_VELMESHEV", 
  ...
  
  {
    ...
    if(color_pal == "PRGn"){
      for(i in geneset_for_direction_reverse){
        tempdata$nes[tempdata$combined_name == i] = -1*tempdata$nes[tempdata$combined_name == i]
      }
    }
